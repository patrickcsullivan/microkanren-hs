...
/* package microkanren-hs-0.1.0.0 */
#ifndef VERSION_microkanren_hs
#define VERSION_microkanren_hs "0.1.0.0"
#endif /* VERSION_microkanren_hs */
#ifndef MIN_VERSION_microkanren_hs
#define MIN_VERSION_microkanren_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_microkanren_hs */
...
#define CURRENT_COMPONENT_ID "microkanren-hs-0.1.0.0-IxjuarhduIhBcfXCb7OIwi-microkanren-hs"
